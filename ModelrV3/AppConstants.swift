...
/// Centralized constants for the ModelrV3 application
struct AppConstants {
    ...
    static let appSupportDirectoryName = "ModelrV3"
    ...
    /// Name of correct self-test mask file
    static let correctSelfTestMaskFileName = "correct_self_test_mask.png"
    
    /// Name of self-test 3D model file
    static let selfTestModelFileName = "self_test_model.obj"
