...
struct AppConstants {
    ...
    /// Hunyuan Std (2.1) model download size estimate (bytes)
    static var hunyuanStdModelBytes: Int64 {
        Int64(ConfigurationService.shared.hunyuanStdModelSizeGb * 1_000_000_000)
    }
